...
add_action( 'admin_init', array('MonotypeInstaller_171843','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MonotypeInstaller_171843','monotype_loadupWebfonts' ));
