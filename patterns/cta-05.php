...
/**
 * Title: CTA 05
 * Slug: bittnerkrull25/cta-05
 * Categories: bittnerkrull25/custom25/custom
 */
?>
<!-- wp:group {"metadata":{"categories":["Call-to-action"],"patternName":"bittnerkrull25/call-to-action-5","name":"Call to Action 5"},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-group alignwide is-style-section-base-2" style="border-radius:8px;padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--30)"><!-- wp:columns -->
