...
/**
 * Title: Feature A5
 * Slug: bittnerkrull25/feature-a5
 * Categories: Feature
 */
?>
<!-- wp:group {"metadata":{"name":"Feature A5"},"layout":{"type":"constrained"}} -->
...
<div style="margin-top:var(--wp--preset--spacing--10);margin-bottom:var(--wp--preset--spacing--10);height:8px" aria-hidden="true" class="wp-block-spacer"></div>
<!-- /wp:spacer -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e('Ex voluptatum quia ut repellat quasi id doloremque modi sed aperiam maxime aut minima harum', 'bittnerkrull25');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e('Aut iste sint eum architecto odit ut ducimus molestiae est veniam ratione. Sit dolores consequatur a quaerat iure in dolorum quis.', 'bittnerkrull25');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. ', 'bittnerkrull25');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div style="margin-top:var(--wp--preset--spacing--10);margin-bottom:var(--wp--preset--spacing--10);height:var(--wp--preset--spacing--10)" aria-hidden="true" class="wp-block-spacer"></div>
<!-- /wp:spacer -->
