...
<h2 class="wp-block-heading alignwide"><?php esc_html_e('Still have questions?', 'bittnerkrull25');?></h2>
<!-- /wp:heading -->
...
echo sprintf( esc_html__( '%1$s%2$sE-Mail%3$s%4$s', 'bittnerkrull25' ), '<strong>', '<strong>', '</strong>', '</strong>' ); ?></p>
<!-- /wp:paragraph -->
...
<p><?php esc_html_e('Write to us via our contact form or to info@prolooks.dev', 'bittnerkrull25');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:paragraph {"style":{"border":{"left":{"color":"var:preset|color|brand-3","width":"2px"}},"spacing":{"padding":{"left":"var:preset|spacing|20"}}}} -->
<p style="border-left-color:var(--wp--preset--color--brand-3);border-left-width:2px;padding-left:var(--wp--preset--spacing--20)"><?php /* Translators: 1. is the start of a 'strong' HTML element, 2. is the start of a 'strong' HTML element, 3. is the end of a 'strong' HTML element, 4. is the end of a 'strong' HTML element */ 
echo sprintf( esc_html__( '%1$s%2$sSocial Media%3$s%4$s', 'bittnerkrull25' ), '<strong>', '<strong>', '</strong>', '</strong>' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|20","left":"var:preset|spacing|20"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)"><!-- wp:social-links {"iconColor":"contrast-3","iconColorValue":"#363B44","showLabels":true,"className":"is-style-logos-only","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|10"}}},"layout":{"type":"flex","orientation":"vertical"}} -->
...
<div class="wp-block-group"><!-- wp:paragraph {"style":{"border":{"left":{"color":"var:preset|color|brand-3","width":"2px"}},"spacing":{"padding":{"left":"var:preset|spacing|20"}}}} -->
<p style="border-left-color:var(--wp--preset--color--brand-3);border-left-width:2px;padding-left:var(--wp--preset--spacing--20)"><?php /* Translators: 1. is the start of a 'strong' HTML element, 2. is the start of a 'strong' HTML element, 3. is the end of a 'strong' HTML element, 4. is the end of a 'strong' HTML element */ 
echo sprintf( esc_html__( '%1$s%2$sPhone%3$s%4$s', 'bittnerkrull25' ), '<strong>', '<strong>', '</strong>', '</strong>' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|20","left":"var:preset|spacing|20"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)"><!-- wp:paragraph -->
<p><?php esc_html_e('Call us +00 000 0000', 'bittnerkrull25');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
