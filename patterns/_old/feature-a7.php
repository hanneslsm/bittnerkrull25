...
/**
 * Title: Feature A7
 * Slug: bittnerkrull25/feature-a7
 * Categories: Feature
 */
?>
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|10"}},"layout":{"type":"default"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"style":{"border":{"left":{"color":"var:preset|color|brand-3","width":"2px"}},"spacing":{"padding":{"left":"var:preset|spacing|20"}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"x-large"} -->
<p class="has-x-large-font-size" style="border-left-color:var(--wp--preset--color--brand-3);border-left-width:2px;padding-left:var(--wp--preset--spacing--20);font-style:normal;font-weight:600"><?php esc_html_e('Et tempora voluptatem', 'bittnerkrull25');?></p>
<!-- /wp:paragraph -->
