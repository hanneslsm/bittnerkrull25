...
/**
 * Title: Highlights A2
 * Slug: bittnerkrull25/highlights-a2
 * Categories: Highlights
 */
?>
<!-- wp:group {"metadata":{"name":"Highlights A2","categories":["feature"],"patternName":"bittnerkrull25/bittnerkrull25-feature-a9"},"layout":{"type":"constrained"}} -->
...
<h2 class="wp-block-heading alignwide"><?php esc_html_e('Feature highlights section title', 'bittnerkrull25');?></h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e('Placeholder text for feature highlight', 'bittnerkrull25');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e('Placeholder text for feature detail', 'bittnerkrull25');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e('Placeholder text for another feature', 'bittnerkrull25');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e('Generic text for feature information', 'bittnerkrull25');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e('Placeholder content for feature description', 'bittnerkrull25');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
