...
<h1 class="wp-block-heading has-text-align-center" style="font-size:4rem"><?php esc_html_e('Hoppla, das sollte nicht passieren!', 'bittnerkrull25');?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php esc_html_e('Entweder Sie haben sich vertippt oder wir haben die Seite verlegt. Aber keine Sorge, wir bringen Sie zurück auf den richtigen Weg.', 'bittnerkrull25');?></p>
<!-- /wp:paragraph -->
