...
<h1 class="wp-block-heading"><?php esc_html_e('Discover our blog and articles', 'bittnerkrull25');?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e('Subscribe to the newsletter or follow us on social media to always stay up to date.', 'bittnerkrull25');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
