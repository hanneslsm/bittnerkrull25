...
echo sprintf( esc_html__( '%1$s← Aktuelle Events anzeigen%2$s', 'bittnerkrull25' ), '<a href="' . esc_url( 'https://stdlsm.com/bittnerkrull/unternehmen/events/' ) . '" data-type="page" data-id="1856">', '</a>' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
