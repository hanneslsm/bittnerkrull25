<?php
/**
 * Title: category-rueckblick
 * Slug: bittnerkrull25/category-rueckblick
 * Inserter: no
 */
?>
...
<!-- wp:cover {"useFeaturedImage":true,"dimRatio":0,"isUserOverlayColor":true,"minHeight":540,"minHeightUnit":"px","contentPosition":"bottom center","isDark":false,"className":"is-style-bittnerkrull-hero","style":{"border":{"bottom":{"color":"var:preset|color|brand-7","width":"6px"}},"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"},"margin":{"top":"-90px"}},"color":{"duotone":"var:preset|duotone|duotone-brand"},"elements":{"heading":{"color":{"text":"var:preset|color|base"}}}},"layout":{"type":"constrained"}} -->
...
<h1 class="wp-block-heading alignwide has-base-color has-text-color has-link-color"><?php esc_html_e('Events', 'bittnerkrull25');?></h1>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->
...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20)"><!-- wp:paragraph {"align":"left"} -->
<p class="has-text-align-left"><?php /* Translators: 1. is the start of a 'a' HTML element, 2. is the end of a 'a' HTML element */ 
echo sprintf( esc_html__( '%1$s← Aktuelle Events anzeigen%2$s', 'bittnerkrull25' ), '<a href="' . esc_url( 'https://www.bittner-krull.de/unternehmen/events/' ) . '" data-type="page" data-id="1856">', '</a>' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
