...
/**
 * Title: Feature A4
 * Slug: bittnerkrull25/feature-a4
 * Categories: Feature
 */
?>
<!-- wp:group {"metadata":{"name":"Feature A4"},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-group"><!-- wp:paragraph {"style":{"layout":{"columnSpan":1,"rowSpan":1},"elements":{"link":{"color":{"text":"var:preset|color|brand-3"}}},"typography":{"fontSize":"4em","fontStyle":"normal","fontWeight":"600"}},"textColor":"brand-3"} -->
<p class="has-brand-3-color has-text-color has-link-color" style="font-size:4em;font-style:normal;font-weight:600"><?php esc_html_e('123+', 'bittnerkrull25');?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group"><!-- wp:paragraph {"style":{"layout":{"columnSpan":1,"rowSpan":1},"elements":{"link":{"color":{"text":"var:preset|color|brand-3"}}},"typography":{"fontSize":"4em","fontStyle":"normal","fontWeight":"600"}},"textColor":"brand-3"} -->
<p class="has-brand-3-color has-text-color has-link-color" style="font-size:4em;font-style:normal;font-weight:600"><?php esc_html_e('456+', 'bittnerkrull25');?></p>
<!-- /wp:paragraph -->
