 ...
 * Slug: bittnerkrull25/testimonials-05
 * Categories: bittnerkrull25/custom
 */
?>
<!-- wp:group {"metadata":{"categories":["Testimonials"],"patternName":"bittnerkrull25/testimonials-6","name":"Testimonials 6"},"layout":{"type":"constrained"}} -->
...
<figure class="wp-block-image size-full is-resized has-custom-border is-style-default"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/placeholder.png" alt="" style="border-radius:999px;aspect-ratio:1;object-fit:cover;width:32px"/></figure>
<!-- /wp:image -->
