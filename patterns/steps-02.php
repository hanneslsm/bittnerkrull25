...
/**
 * Title: Steps 02
 * Slug: bittnerkrull25/steps-02
 * Categories: bittnerkrull25/custom
 */
?>
<!-- wp:group {"metadata":{"categories":["Steps"],"patternName":"bittnerkrull25/steps-2","name":"Steps 2"},"layout":{"type":"constrained"}} -->
...
<li><?php esc_html_e('Id nemo placeat id aperiam laudantium ea accusamus repellendus.', 'bittnerkrull25');?></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><?php esc_html_e('Galisum unde sit tenetur beatae et explicabo atque nam nemo ipsa.', 'bittnerkrull25');?></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><?php esc_html_e('Non voluptatem corrupti non cumque quia!', 'bittnerkrull25');?></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><?php esc_html_e('Sit aperiam omnis qui incidunt veniam aut vitae possimus At facilis nulla?', 'bittnerkrull25');?></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><?php esc_html_e('A placeat consequatur qui labore soluta!', 'bittnerkrull25');?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
