 ...
 * Slug: bittnerkrull25/call-to-action-6
...
<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/placeholder-3E0847B1-8508-46B6-A63F-D9152E444F8D-1024x682.png","isUserOverlayColor":true,"minHeight":150,"minHeightUnit":"px","customGradient":"linear-gradient(90deg,rgb(255,255,255) 0%,rgba(255,255,255,0.31) 51%,rgb(255,255,255) 100%)","sizeSlug":"large","align":"wide","style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast-3"}}},"spacing":{"padding":{"right":"var:preset|spacing|30","left":"var:preset|spacing|30"}}},"textColor":"contrast-3"} -->
<div class="wp-block-cover alignwide has-contrast-3-color has-text-color has-link-color" style="padding-right:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30);min-height:150px"><img class="wp-block-cover__image-background  size-large" alt="" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/placeholder-3E0847B1-8508-46B6-A63F-D9152E444F8D-1024x682.png" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-100 has-background-dim wp-block-cover__gradient-background has-background-gradient" style="background:linear-gradient(90deg,rgb(255,255,255) 0%,rgba(255,255,255,0.31) 51%,rgb(255,255,255) 100%)"></span><div class="wp-block-cover__inner-container"><!-- wp:columns -->
