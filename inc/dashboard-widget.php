...
/**
 * bittnerkrull25 Dashboard Widget
 *
...
add_action('wp_dashboard_setup', 'bittnerkrull25_dashboard_widgets');
function bittnerkrull25_dashboard_widgets()
{
	wp_add_dashboard_widget('bittnerkrull25_help_widget', 'Theme Support & Server Info', 'bittnerkrull25_dashboard_help');
}

function bittnerkrull25_dashboard_help()
{
	$theme = wp_get_theme();
