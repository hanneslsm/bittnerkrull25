...
function bittnerkrull25_enqueue_scripts() {
...
add_action('enqueue_block_assets', 'bittnerkrull25_enqueue_scripts');

function bittnerkrull25_enqueue_frontend_styles() {
    ...
    wp_enqueue_style(
        'bittnerkrull25-screen-style',
        $screen_style_path,
        $screen_style_asset['dependencies'],
        $screen_style_asset['version']
    );
}
add_action('wp_enqueue_scripts', 'bittnerkrull25_enqueue_frontend_styles');

function bittnerkrull25_enqueue_editor_styles() {
    ...
    wp_enqueue_style(
        'bittnerkrull25-editor-style',
        $editor_style_path,
        $editor_style_asset['dependencies'],
        $editor_style_asset['version']
    );
}
add_action('enqueue_block_editor_assets', 'bittnerkrull25_enqueue_editor_styles');
